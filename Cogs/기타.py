...
class _기타(commands.Cog):
    ...
    @commands.slash_command(name='정보',guild_ids=guild_ids,description='다시 태어난 설레봇의 정보에요! 설레봇은 아직 많은 기능을 조정하고 있어요. 대부분의 기능이 매끄럽지 않게 작동하거나 초기화될 수 있어요.')
    async def 정보(self, ctx):
        ...
        embed.add_field(name='개발자',value='하토(ghwls030306@s-r.ze.am)',inline = False)
    ...
    async def 소개(self,ctx):
        ...
        embed.add_field(name='설빈레피딕스는?',value="설빈레피딕스는 망망대해에 떠 있는 이 세계관의 유일한 대륙, '하늘민국'의 유일한 철도 회사에요. 2011년 4월 30일 하늘민국 오픈과 동시에 설립되었고, 2023년 4월 30일 12주년을 맞이했어요.\n사실 '설빈레피딕스'라는 회사는 2017년 8월 5일 우리나라로 따지면 충북선, 경강선 원주~강릉 구간 같은 광역철도를 담당하기 위한 회사로 출범했어요. 도시철도는 '하늘메트로'라는 회사가 맡고 있었고요. (물론 둘 다 대표는 하토였어요) 그런데 어쩌다 보니까 2018년 초, 하늘메트로가 설빈레피딕스에 합병되게 되었어요. 단지 '이름이 멋지다'는 이유였죠. 따라서 지금은 하늘민국의 모든 철도노선을 운행하고 있답니다.\n도움을 주신 분 : 신내기지, 푸른나래(구문 등을 알려주심) 신내기지, CoolMetro (텍스쳐) Nexon Korea, SQUARE MUSIQ (안내방송 BGM) CeVIO CS7 사토 사사라, Clova AI (안내방송) 電車の音のページ (구동음) ~~예정 : 나고코모(Nagoya_Common), 슈크림 (텍스쳐) CeVIO AI 스즈키 츠즈미, 가능하다면 아메냥 (안내방송) 하토, 故 4시(4hour4444) (안내방송 BGM)~~\n더 자세한 정보는 이 쪽을 참고해주세요! http://utwiki.pe.kr/r/%EC%84%A4%EB%B9%88%EB%A0%88%ED%94%BC%EB%94%95%EC%8A%A4",inline=False)
