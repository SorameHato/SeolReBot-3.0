...
__대사__ = [ #월요일
    ...
    ['드디어 불금이에요! 불금을 제대로 불태우기 위해, 오늘은 일찍 주무세요! 안녕히 주무세요!', # 목 2300 ~ 금 0030
     '좋은 아침이에요! 드디어 금 같은 금요일이 찾아왔어요! 오늘도 빠른 설빈레피딕스 열차를 타고 직장까지 빛의 속도로 이동해봐요!', # 금 0630 ~ 금 0800
     '드디어 불금이에요! 오늘만 버티면 주말동안 놀거나 쉴 수 있으니까, 오늘은 모든 것을 불태워서 열심히 일해봐요! 오늘 야근을 하는 건 슬프잖아요?', # 금 0900 ~ 금 1100
     '', # 금 1100 ~ 금 1300
     '', # 금 1300 ~ 금 1430
     '', # 금 1430 ~ 금 1630
     '', # 금 1800 ~ 금 1930
