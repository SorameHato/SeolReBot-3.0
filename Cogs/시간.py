...
__대사__ = [ #월요일
    ...
    ['오늘 하루도 수고하셨어요! 내일은 화요일.. 아직까지는 한 주의 시작이지만 그래도 벌써 평일의 20%가 지났어요! 내일도 화이팅이에요! 안녕히 주무세요!', #월 2300 ~ 화 0030
     ...
     '점심은 맛있게 드셨나요? 전 결국 바깥에 나가서 샐러드를 먹었어요. 진짜로 서지은승무본부 구내식당은 돈이 아까울 정도에요!', #화 1300 ~ 화 1430
    ...
    ['벌써 한 주의 절반이 지나가고 있어요! 오늘 하루도 수고하셨어요! 안녕히 주무세요!', # 화 2300 ~ 수 0030
     '좋은 아침이에요! 벌써 한 주의 절반, 수요일이에요! 오늘도 푸른 하늘을 보면서 설빈레피딕스 열차를 타고 기분 좋게, 상쾌하게 시작해요!', # 수 0630 ~ 수 0800
     ...
     '오늘도 수고하셨어요! 벌써 한 주의 절반이 지나갔어요! 빠른 설빈레피딕스 열차를 타고 빛의 속도로 퇴근해요!', # 수 1800 ~ 수 1930
     '해가 지는 걸 보면 \'너는 나의 후회\' 2권의 한 장면이 떠올라요. \'수염을 깎다, 그리고 여고생을 줍다\'를 쓰신 시메시바님의 작품이에요. 여러분도 한 번 읽어보시는 게 어떠신가요?', # 수 1930 ~ 수 2100
     '이제 완전히 밤이네요. 오늘은 자기 계발에 도전하려고 해요! 물론 전차로 Go나 OpenBVE를 하는 것 뿐이지만요.' # 수 2100 ~ 수 2300
    ], #목요일
    ['한 주의 반이 지났어요! 내일 하루만 버티면 불금이에요! 오늘 하루도 수고하셨어요! 안녕히 주무세요!', # 수 2300 ~ 목 0030
     ...
     '오늘도 하늘민국의 하늘은 높고 파래요! 거의 매일 가을 같은 날씨만 계속되어서 살기 좋은 것 같아요.', # 목 0900 ~ 목 1100
     '벌써 점심시간이에요! 오늘은 글로벌 데이라면서 구내식당에서 여러 국가의 가정식이 나오는 날이에요! 어떤 국가의 음식이 나올까요? 개인적으로는 일식이었으면 좋겠어요!', # 목 1100 ~ 목 1300
     '점심은 맛있게 드셨나요? 다른 나라의 가정식은 대부분 맛있는 것 같아요! 오후에도 힘내서 열심히 일해봐요!', # 목 1300 ~ 목 1430
     '슬슬 나른해지는 시간이에요... 몰래 틈틈이 애니나 라노벨 같은 걸 보면서 버텨야겠어요.', # 목 1430 ~ 목 1630
    ...
    ['드디어 내일이 불금이에요! 불금을 제대로 불태우기 위해, 오늘은 일찍 주무세요! 안녕히 주무세요!', # 목 2300 ~ 금 0030
     ...
     '슬슬 점심시간이에요! 몇 시간만 더 버티면 퇴근이에요! 그러면 이틀동안 일에서 해방되는 거에요! 벌써부터 신나는 것 같지 않으신가요?', # 금 1100 ~ 금 1300
     ...
     '(유설레가 자리를 비웠습니다. 양서도 유신시 엔유구 강냥동 북해해안길 8구간 강냥해수욕장~혜슬철교 구간으로 가시면 신나서 산책로를 달리고 있는 유설레를 보실 수 있을 것 같습니다.)', # 금 1930 ~ 금 2100
