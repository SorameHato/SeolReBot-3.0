...
import sys
bot = discord.Bot()
ver = "3.2_2023051100 rev 2.33-ReBirth 01 build 198" + "AronaBot Branch"
guild_ids = [
...
async def on_ready():
    ...
    await bot.change_presence(status=discord.Status.online, activity=discord.Activity(type=discord.ActivityType.listening, name='/도움말 | 아로나봇 v3.2'))
...
async def on_application_command_error(ctx, error):
    ...
    embed.set_footer(text=f'아로나봇 버전 {ver}')
